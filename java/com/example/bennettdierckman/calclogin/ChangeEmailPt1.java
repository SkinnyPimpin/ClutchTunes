 ...
 */
public class ChangeEmailPt1 extends Fragment {

    public ChangeEmailPt1() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_change_email_pt1, container, false);
        ...
        bNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!currentPassword.equals(password)) {
                    ...
                    fragmentTransaction.replace(R.id.flcontent, changeEmail);
