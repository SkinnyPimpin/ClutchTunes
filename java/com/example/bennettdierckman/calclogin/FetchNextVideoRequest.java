...
class FetchNextVideoRequest extends StringRequest{
    //url that the php file is at
    private static final String FETCH_NEXT_VIDEO_REQUEST_URL = "https://cgi.soic.indiana.edu/~team51/FetchNextVideoRequest.php";
    //Binds the paramaters as assigned in loginActivity.java
    private Map<String, String> params;

    //Prepares android input to be sent to file location
    public FetchNextVideoRequest(String partyTitle, String songID, Response.Listener<String> listener) {
        super(Request.Method.POST, FETCH_NEXT_VIDEO_REQUEST_URL, listener, null);
        params = new HashMap<>();
